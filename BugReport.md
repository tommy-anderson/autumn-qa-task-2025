...
| #  | Bug Title                                                          | Severity    |
|----|--------------------------------------------------------------------|-------------|
| 1  | Deleting a task removes all of the tasks that with the same title  | Major       |
...
| 8  | Add Task Button Does Not Disable Correctly                         | Minor / UX  |
| 9  | Loading Spinner on Edit Hover                                      | Major / UX  |
...
5. **Sorting UI:** Could be more user friendly. For example, show a clear “Sort By” section with Label and Importance options:
